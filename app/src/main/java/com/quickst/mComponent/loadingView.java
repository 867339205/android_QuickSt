...
public class loadingView extends LinearLayout {
    ...
    private com.quickst.mComponent.shapView mShapeView;//形状
    ...
    /*    //1.1实例化view
        ...
        inflate(mContext, R.layout.loading, this);
        mShadeView = findViewById(R.id.shadow_view);
        mShapeView = (com.quickst.mComponent.shapView) findViewById(R.id.shape_view);
        post(new Runnable() {
            @Override
            public void run() {
    ...
    public void setVisibility(int visibility) {
        super.setVisibility(visibility);// 不要再去排放和计算，少走一些系统的源码
        //清理所有动画
